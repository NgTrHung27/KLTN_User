...
const variants = {
  base: "col-span-2 relative rounded-md aspect-square flex justify-center items-center flex-col cursor-pointer min-h-[150px] min-w-[200px] border border-dashed border-gray-400 dark:border-gray-300 transition-colors duration-200 ease-in-out",
  image:
    ...
    return (
      <div className="relative">
        ...
        <Card className="flex items-center justify-center">
          <CardContent className="relative grid max-w-[90%] grid-cols-2 gap-2 p-0  pt-2">
            {/* Images */}
            {value?.length! > 4 ? (
              <>
                {value?.map(
                  ({ file, progress }, index) =>
                    index <= 2 && (
                      <div
                        key={index}
                        className={
                          variants.image + " aspect-square h-full flex-1"
                        }
                      >
                        <img
                  ...
                  ({ file, progress }, index) =>
                    index === 3 && (
                      <div
                        ...
                        className={
                          variants.image +
                          "relative aspect-square h-full flex-1"
                        }
                      >
                        <Image
                          fill
                          ...
                          alt={typeof file === "string" ? file : file.name}
                        />
                        <div className="absolute left-0 top-0 flex h-full w-full items-center justify-center bg-primary/30 text-3xl font-semibold text-white dark:text-zinc-400">
                          +{value?.length! - 3}
                        </div>
                        {/* Progress Bar */}
                        {typeof progress === "number" && (
              ...
              value?.map(({ file, progress }, index) => (
                <div
                  key={index}
                  className={cn(
                    variants.image + "relative aspect-square h-full flex-1",
                    value.length === 1 && "col-span-2",
                  )}
                >
                  <img
                    className="h-full w-full rounded-md object-cover"
            ...
            {(value?.length === 0 ||
              ...
              >
                ...
                <div className="flex flex-col items-center justify-center text-xs text-gray-400">
                  ...
                  <div className="text-gray-400">Select images to upload</div>
                  <div className="mt-3">
  ...
  return (
    <button
      ...
      className={twMerge(
        ...
        // color
        "border border-primary text-primary shadow hover:bg-gray-100 hover:text-gray-500 dark:border-gray-600 dark:text-gray-100 dark:hover:bg-gray-700",
        // size
